...
\This project is a microservices-based feedback system developed for "DevOpsHub" startup\[cite: 6]. \[cite\_start]It consists of two main applications interacting with a shared Redis database to collect user messages and track page visits\[cite: 14, 15].



\## Architecture Description

\The system follows a \*\*Producer-Observer\*\* pattern\[cite: 15]:
...
\* \\*\*Redis:\*\* Central database for data persistence and communication between services\[cite: 9, 18].
